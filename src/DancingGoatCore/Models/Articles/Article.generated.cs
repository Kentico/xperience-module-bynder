...
namespace CMS.DocumentEngine.Types.DancingGoatCore
{
	...
	public partial class Article : TreeNode
	{
		...
		/// </summary>
		[DatabaseField]
		public string ArticleTeaserWithBynder
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ArticleTeaserWithBynder"), @"");
			}
			set
			{
				SetValue("ArticleTeaserWithBynder", value);
			}
		}
		...
		public partial class ArticleFields : AbstractHierarchicalObject<ArticleFields>
		{
			...
			/// Bynder teaser.
			/// </summary>
			public string TeaserWithBynder
			{
				get
				{
					return mInstance.ArticleTeaserWithBynder;
				}
				set
				{
					mInstance.ArticleTeaserWithBynder = value;
				}
			}
